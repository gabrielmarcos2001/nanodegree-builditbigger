 ...
 */
public class ViewGetJokeButton extends RelativeLayout {
    ...
    public ViewGetJokeButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        inflateLayout(context, null);
    ...
    private void inflateLayout(Context context, AttributeSet attrs) {
        ...
        inflater.inflate(R.layout.joke_button, this, true);
